...
const { createResume, getAllResumes, updatePersonalInfo, getResumeById, updateSummary, updateExperience } = require("../controllers/resumeController");
...
router.put("/resume/:resumeId/experience" , authMiddleware,updateExperience);
