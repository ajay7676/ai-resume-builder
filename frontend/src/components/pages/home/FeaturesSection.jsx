...
const FeaturesSection = () => {
  ...
  return (
    <div id="features" className="flex flex-col items-center my-10 scroll-mt-12">
        ...
        <Title title={`Build your resume` } description={`our streamlined process hepls you create a professional resume in minutes with intelligent AI-powered tools and features.`} />
